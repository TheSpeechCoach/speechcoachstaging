        ...
        >
          {courses.map((course, i) => (
            <motion.div
              key={i}
              variants={revealItem}
              className="bg-card border border-border rounded-lg p-6 md:p-8 flex flex-col hover:border-primary/60 transition-all duration-300 hover:shadow-xl hover:shadow-primary/10"
            >
