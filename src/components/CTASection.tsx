    ...
    <section id="cta" className="py-16 md:py-20">
      <div className="container mx-auto px-6 text-center">
        ...
        >
          <Link
            to="/book-now"
            className="inline-block bg-primary text-primary-foreground hover:bg-background hover:text-primary transition-all px-10 py-4 rounded-full font-body text-sm tracking-wide glow-gold"
          >
            Book Now
          </Link>
          <a
