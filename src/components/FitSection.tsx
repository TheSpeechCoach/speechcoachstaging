        ...
        >
          {criteria.map((c, i) => (
            <motion.div
              key={i}
              variants={revealItem}
              className="flex gap-4 items-start bg-card border border-border rounded-xl p-8 hover:border-primary/60 transition-all duration-300 hover:shadow-xl hover:shadow-primary/10"
            >
