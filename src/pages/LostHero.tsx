              ...
              return (
                ...
                >
                  <Link
                    ...
                    className="block h-full bg-card border border-border rounded-lg px-4 py-3 font-body text-sm text-muted-foreground hover:bg-primary hover:text-primary-foreground hover:border-primary transition-colors"
                  >
                    {label}
                  </Link>
                </motion.div>
