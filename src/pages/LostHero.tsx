              ...
              return (
                ...
                >
                  <Link
                    ...
                    className="block h-full bg-card border border-border rounded-lg px-4 py-3 font-body text-sm text-muted-foreground hover:text-primary hover:border-primary/60 transition-colors"
                  >
                    {label}
                  </Link>
                </motion.div>
