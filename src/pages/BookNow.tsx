          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="inline-flex items-center gap-2 bg-primary text-primary-foreground hover:bg-primary/80 transition-all px-8 py-3 rounded-full font-body text-sm font-medium glow-gold"
                >
